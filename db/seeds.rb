...
purchase1 = Purchase.new({"amount" => 10, "merchant_id" => merchant3.id, "date_picked" => "now", "type" => merchant3.type, "user_id" => user1.id})
purchase1.save
purchase2 = Purchase.new({"amount" => 5, "merchant_id" => merchant3.id, "date_picked" => "04-04-2019", "type" => merchant3.type, "user_id" => user2.id})
purchase2.save
purchase3 = Purchase.new({"amount" => 50, "merchant_id" => merchant1.id, "date_picked" => "03-03-2019", "type" => merchant3.type, "user_id" => user3.id})
purchase3.save
purchase4 = Purchase.new({"amount" => 70, "merchant_id" => merchant1.id, "date_picked" => "02-02-2019", "type" => merchant3.type, "user_id" => user3.id})
purchase4.save
